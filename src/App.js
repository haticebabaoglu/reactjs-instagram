...
import Input from "../src/cpmponent/input";
...
function App() {
  ...
  useEffect(() => {
    let images = imageContainerRef.current.querySelectorAll("img"),
    total = images.length,
    current = 0;
    const imageSlider = () => {
      if (current > 0) {
...
return (
  <>
    <div className="h-full w-full flex items-center justify-center">
      <div className="hidden md:block w-[380px] h-[581px] bg-logo-pattern relative bg-[length:468.32px_634.15px] bg-[topleft-46px]">
        <div className="w-[250px] h-[538px] absolute top-[27px] right-[18px]" ref={imageContainerRef}>
          <img
