...
export default function Input({ label, type = 'text', ...props }) {
  ...
  return (
    <label className="block relative flex bg-zinc-50 border rounded-lg focus-within:border-gray-400">
      <input
        ref={inputRef}
        required={true}
        type={inputType}
        className="px-2 py-2  outline-none text-xl w-full h-[38px] valid:pt-[10px] peer" 
        {...props}
      />
